...
// ROCKWOLF v37: per-boot pulse stats for the boot-failure trace
extern uint16_t rw_trace_pulse_last;
extern uint16_t rw_trace_pulse_min;
extern uint16_t rw_trace_pulse_max;
extern uint8_t rw_trace_good_frames;
