...
#define RW_FW_TAG "_v62" // Rockwolf firmware version suffix, appended to the embedded name, read by the tuner
#define FIRMWARE_NAME "FD6288_PA2  "
// ROCKWOLF v19: this board has battery voltage on PA6 and the current-sense amp
// on PA3 - opposite of the generic F051 defaults. Verified on hardware: PA6
// idles at Vbatt/6.5 (1286mV on a full 2S), PA3 idles at ~770mV (amp offset).
#define CURRENT_ADC_PIN LL_GPIO_PIN_3
#define CURRENT_ADC_CHANNEL LL_ADC_CHANNEL_3
#define VOLTAGE_ADC_PIN LL_GPIO_PIN_6
#define VOLTAGE_ADC_CHANNEL LL_ADC_CHANNEL_6
// ROCKWOLF v21: bench-calibrated scales. Voltage: meter 7.94V vs fw 7.9V (divider 59, done).
// Current: clean CTT-off steady hold - meter 2.94A vs fw 4.9A at 19mV/A => true scale ~31.7mV/A
// (consistent with the 1mOhm shunt + ~32x amp gain on this board)
#define MILLIVOLT_PER_AMP 32
#define SINE_DIVIDER 1
#define DEAD_TIME 45
#define HARDWARE_GROUP_F0_A
#define TARGET_VOLTAGE_DIVIDER 59
// v37-slim: USE_SERIAL_TELEMETRY removed from this target to reclaim flash for
// the diagnostic build (telemetry frames on the signal line after arming —
// not needed for baseline capture runs).
#endif
